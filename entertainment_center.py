...
rear_window = media.Movie("Rear Window",
                          "Sitting in a wheelchair, a photographer spies on"
                          " courtyard neighbors and sees a murder",
                          "https://upload.wikimedia.org/wikipedia/commons/3"
                          "/38/Rear_Window_film_poster.jpg",
...
lala_land = media.Movie("La La Land",
                        "Two young people in Los Angeles try to navigate"
                        " love and careers",
                        "https://upload.wikimedia.org/wikipedia/en/e/e2/"
                        "La_La_Land_Poster.jpg",
                        "https://www.youtube.com/watch?v=0pdqf4P9MB8")
casablanca = media.Movie("Casablanca",
                         "A nightclub owner helps an old flame and her "
                         " husband escape the Germans",
                         "https://upload.wikimedia.org/wikipedia/commons/b/"
                         "b3/CasablancaPoster-Gold.jpg",
                         "https://www.youtube.com/watch?v=BkL9l7qovsE")

#This is the array that fresh_tomatoes uses to display Movie Objects
